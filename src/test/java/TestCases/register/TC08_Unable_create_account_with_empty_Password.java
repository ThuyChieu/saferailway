...
public class TC08_Unable_create_account_with_empty_Password extends BaseTest {
    private RegisterPage registerPage;

    @Test(dataProvider = "getDataForTest", description = "User can't create account while password field is empty")
    public void TC08_REGISTER(Hashtable<String, String> data) {
        try {
            ...
            logStep = TestReporter.logStepInfo(logMethod, "Step #3: Leaving password field empty");
            registerPage.register(GlobalVariables.email, "", "", GlobalVariables.autoGeneratePID);
            ...
            Assert.assertEquals(passErrorMsg, data.get("PasswordErrMessage"));
        } catch (Exception e) {
