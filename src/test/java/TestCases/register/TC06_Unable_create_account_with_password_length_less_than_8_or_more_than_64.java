...
public class TC06_Unable_create_account_with_password_length_less_than_8_or_more_than_64 extends BaseTest {
    private RegisterPage registerPage;

    @Test(dataProvider = "getDataForTest", description = "Unable to register new account by using password length less than 8 or more than 64")
    public void TC06_REGISTER(Hashtable<String, String> data) {
        try {
            ...
            registerPage.register(GlobalVariables.autoGenerateEmail, data.get("Password"), data.get("Password"), GlobalVariables.autoGeneratePID);

            String errorMsg = registerPage.errorMsg();
            String pageEmailErrorMessage = registerPage.passErrorMsg();
            ...
            Assert.assertEquals(pageEmailErrorMessage, data.get("PassErrMessage"));
        } catch (Exception e) {
